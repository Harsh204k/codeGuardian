...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Input directory containing Main_DataSet.xlsx (auto-detected if not provided)'
    )
    parser.add_argument(
        '--output-dir',
        type=str,
    ...
    if args.input_dir:
        ...
        input_dir = get_dataset_path("github_ppakshad/raw")
    
    if args.output_dir:
        output_dir = Path(args.output_dir).resolve()
    else:
        output_dir = get_output_path("github_ppakshad/processed")
    
    logger.info(f"[INFO] Processing github_ppakshad dataset from: {input_dir}")
