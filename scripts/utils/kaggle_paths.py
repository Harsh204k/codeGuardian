...
def get_dataset_path(dataset_name: str) -> Path:
    ...
    Examples:
        ...
        # Kaggle: /kaggle/input/codeguardian-datasets/devign/raw
    """
    if in_kaggle():
...
def get_output_path(subdir: str = "processed", create: bool = True) -> Path:
    ...
    if in_kaggle():
        ...
        base = Path(__file__).resolve().parents[2] / "cache" / "processed_datasets_unified"
...
def print_environment_info():
    ...
    if in_kaggle():
        print(f"📁 Input Base:  /kaggle/input/codeguardian-datasets")
