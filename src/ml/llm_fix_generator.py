        ...
        for result in results:
            ...
            if "# Fixed Code:" in generated:
                ...
                fixes.append({
                    ...
                    "confidence": self._calculate_fix_confidence(fixed_code, vulnerability_type)
                })
...
class FixTrainingDataGenerator:
    ...
    def format_for_training(pairs):
        ...
        formatted = []
        for pair in pairs:
            text = f"Fix {pair['vulnerability']}: {pair['vulnerable']} → {pair['secure']}"
...
if __name__ == "__main__":
    ...
    vulnerable = "String query = \"SELECT * FROM users WHERE name = '\" + userName + \"'\";"
